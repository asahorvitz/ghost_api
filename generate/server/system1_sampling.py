...
class System1_Generator(system_template.Story_Generator):
    SAMPLING_MODEL_FILE = "art_project_v1_uncased_sent_n_word_tok_thresh5_lr2.5.pt"
    SAMPLING_VOCAB_FILE = "art_project_v1_uncased_sent_n_word_tok_thresh5.pkl"
...
def main():
    gen = System1_Generator("555")
    topic = input("Enter a title: ")
    story_temp = float(input("Story diversity: "))
    max_len = int(input("Maximum length: "))
    print(gen.generate_response(topic, kw_temp=None, story_temp=story_temp, dedup=None, max_len=max_len, use_gold_titles=None, oov_handling=None))
